...
impl<I2C: I2c> Adxl345<I2C, Async> {
    ...
    pub async fn get_device_id(&mut self) -> Result<u8, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_DEVICE_ID, &mut buf).await?;
        Ok(buf[0])
    }
    ...
    pub async fn get_axis_offsets(&mut self) -> Result<(i8, i8, i8), I2C::Error> {
        let mut buf = [0u8; 3];
        self.read_register(register::ADXL345_OFFSET_X, &mut buf).await?;
    ...
    pub async fn set_axis_offsets(&mut self, x: i8, y: i8, z: i8) -> Result<(), I2C::Error> {
        self.write_register(register::ADXL345_OFFSET_X, x as u8).await?;
        self.write_register(register::ADXL345_OFFSET_Y, y as u8).await?;
        self.write_register(register::ADXL345_OFFSET_Z, z as u8).await?;
        Ok(())
    }
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_low_power_mode(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_data_rate(&mut self) -> Result<DataRate, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_BW_RATE, &mut buf).await?;
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_link_mode(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_auto_sleep(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_POWER_CONTROL, &mut buf).await?;
        let power_ctrl = PowerControl::from_bits_truncate(buf[0]);
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_standby_mode(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_POWER_CONTROL, &mut buf).await?;
        let power_ctrl = PowerControl::from_bits_truncate(buf[0]);
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_full_resolution(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_grange(&mut self) -> Result<GRange, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_DATA_FORMAT, &mut buf).await?;
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_fifo_mode(&mut self) -> Result<FifoMode, I2C::Error> {
        let mut buf = [0u8; 1];
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_fifo_samples(&mut self) -> Result<u8, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_FIFO_CONTROL, &mut buf).await?;
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_fifo_trigger(&mut self) -> Result<bool, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_FIFO_STATUS, &mut buf).await?;
    ...
    ///
    /// Returns an error if the I2C communication fails
    pub async fn get_fifo_entries(&mut self) -> Result<u8, I2C::Error> {
        let mut buf = [0u8; 1];
        self.read_register(register::ADXL345_FIFO_STATUS, &mut buf).await?;
        let control = FifoStatus::from_bits_truncate(buf[0]);
    ...
    async fn write_register(&mut self, register: u8, value: u8) -> Result<(), I2C::Error> {
        self.i2c.write(self.address, [register, value].as_slice()).await
    }
}
